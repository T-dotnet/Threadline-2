  ...
  return (
    <div style={{ padding: "0 0 64px" }}>
      <div style={{ ...cardStyle }}>
        ...
        {/* Tabs and Content */}
        <div style={{ background: "white", border: `1px solid ${DIVIDER}`, borderRadius: 12, flex: 1, display: "flex", flexDirection: "column" }}>
          {/* Tabs header */}
          <div style={{ display: "flex" }}>
            <button 
              onClick={() => setActiveTab("Transcript")}
              style={{ 
                flex: 1, padding: "12px", borderBottom: activeTab === "Transcript" ? `3px solid ${BRAND}` : `1px solid ${DIVIDER}`,
                background: activeTab === "Transcript" ? "white" : "#f8fafc",
                color: activeTab === "Transcript" ? TEXT_PRIMARY : TEXT_SECONDARY,
                fontWeight: 500, cursor: "pointer", borderRight: `1px solid ${DIVIDER}`,
            ...
            <button 
              ...
              style={{ 
                flex: 1, padding: "12px", borderBottom: activeTab === "Context" ? `3px solid ${BRAND}` : `1px solid ${DIVIDER}`,
                background: activeTab === "Context" ? "white" : "#f8fafc",
                color: activeTab === "Context" ? TEXT_PRIMARY : TEXT_SECONDARY,
          ...
          <div style={{ padding: 24, flex: 1 }}>
            <h2 style={{ fontSize: 20, color: TEXT_PRIMARY, fontWeight: 400, margin: "0 0 4px" }}>Context</h2>
      ...
      <div style={{ border: `1px solid ${DIVIDER}`, borderRadius: 12, background: "white", padding: 24, display: "flex", flexDirection: "column", gap: 24 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
             ...
             <div style={{ marginTop: 24 }}>
                <h1 style={{ fontSize: 24, fontWeight: 400, margin: 0 }}>Notes</h1>
                <p style={{ fontSize: 14, color: TEXT_SECONDARY, margin: 0 }}>Notes</p>
             </div>
          </div>
        ...
        <div style={{ 
          ...
          overflowY: "auto"
           ...
           <h3 style={{ fontSize: 16, fontWeight: 600, marginBottom: 16 }}>Referral Note</h3>
